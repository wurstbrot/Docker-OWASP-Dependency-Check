...
WORKDIR /report
ENTRYPOINT /usr/share/dependency-check/bin/dependency-check.sh --scan "/src" --project "dependeny-check-project" --format "ALL"  --suppression "/src/security/dependency-check-suppression.xml"
